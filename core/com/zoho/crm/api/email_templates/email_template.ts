...
class EmailTemplate implements Template, Model {
	 ...
	 * @returns An instance of EmailTemplate
	 */
	public getFolder(): EmailTemplate	{
		return this.folder;
	 ...
	 * @param folder An instance of EmailTemplate
	 */
	public setFolder(folder: EmailTemplate): void	{
		this.folder = folder;
