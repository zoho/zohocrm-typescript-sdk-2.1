...
class PickListValue implements Model {
	...
	private forecastCategory: bigint;
	 ...
	 * @returns A bigint representing the forecastCategory
	 */
	public getForecastCategory(): bigint	{
	 ...
	 * @param forecastCategory A bigint representing the forecastCategory
	 */
	public setForecastCategory(forecastCategory: bigint): void	{
