...
class TransferActionWrapper implements Model, TransferActionHandler {
	...
	private transferPipeline: Array<TransferActionResponse>;
	private keyModified: Map<string, number> = new Map<string, number>();
	/**
	 * The method to get the transferPipeline
	 * @returns An Array representing the transferPipeline
	 */
	public getTransferPipeline(): Array<TransferActionResponse>	{
	 ...
	 */
	public setTransferPipeline(transferPipeline: Array<TransferActionResponse>): void	{
