...
export class EmailTemplate {
    public static async getEmailTemplates(moduleAPIName: string) {
        ...
        paramInstance.add(ZOHOCRMSDK.EmailTemplates.GetEmailTemplatesParam.MODULE, moduleAPIName);
        ...
        if (response != null) {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.EmailTemplates.ResponseWrapper) {
                ...
                emailTemplates.forEach(emailTemplate => {
                    ...
                    let module: ZOHOCRMSDK.Modules.Module = emailTemplate.getModule();
                    ...
                    let createdBy: ZOHOCRMSDK.Users.User = emailTemplate.getCreatedBy();
                    ...
                    let folder: ZOHOCRMSDK.EmailTemplates.EmailTemplate = emailTemplate.getFolder();
                    ...
                    let modifiedBy: ZOHOCRMSDK.Users.User = emailTemplate.getModifiedBy();
    ...
    static async getEmailTemplateById(Id: bigint) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.EmailTemplates.ResponseHandler.MasterModel> = await emailTemplatesOperations.getEmailTemplateById(Id);
