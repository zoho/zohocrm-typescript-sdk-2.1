...
export class Tags {
    ...
    public static async getTags(moduleAPIName: string) {
        ...
        //Get instance of ZOHOCRMSDK.Tags.TagsOperations Class
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                //Check if expected ZOHOCRMSDK.Tags.ResponseWrapper instance is received
                if (responseObject instanceof ZOHOCRMSDK.Tags.ResponseWrapper) {
                    ...
                    tags.forEach(tag => {
                        ...
                        let modifiedBy: ZOHOCRMSDK.Users.User = tag.getModifiedBy();
                        ...
                        let createdBy: ZOHOCRMSDK.Users.User = tag.getCreatedBy();
    ...
    public static async createTags(moduleAPIName: string) {
        ...
        //Get instance of ZOHOCRMSDK.Tags.BodyWrapper Class that will contain the request body
        ...
        for (let index = 0; index < 3; index++) {
            ...
            //Set Name to tag
            tag.setName("TypeScript-Tag" + index.toString());

            //Add the Tag instance to array
            tagsArray.push(tag);
        }

        //Set the array to tags in ZOHOCRMSDK.Tags.BodyWrapper instance
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                //Check if expected ZOHOCRMSDK.Tags.ActionWrapper instance is received
                if (responseObject instanceof ZOHOCRMSDK.Tags.ActionWrapper) {
                    //Get the array of obtained ZOHOCRMSDK.Tags.ActionResponse.MasterModel instances
    ...
    public static async updateTags(moduleAPIName: string) {
        ...
        tag.setId(BigInt("347706113317003"));
    ...
    public static async addTagsToRecord(moduleAPIName: string, recordId: bigint, tagNames: string[]) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Tags.RecordActionHandler.MasterModel> = await tagsOperations.addTagsToRecord(recordId, moduleAPIName, paramInstance);
    ...
    public static async removeTagsFromRecord(moduleAPIName: string, recordId: bigint, tagNames: string[]) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Tags.RecordActionHandler.MasterModel> = await tagsOperations.removeTagsFromRecord(recordId, moduleAPIName, paramInstance);
    ...
    public static async addTagsToMultipleRecords(moduleAPIName: string, recordIds: bigint[], tagNames: string[]) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Tags.RecordActionHandler.MasterModel> = await tagsOperations.addTagsToMultipleRecords(moduleAPIName, paramInstance);
    ...
    public static async removeTagsFromMultipleRecords(moduleAPIName: string, recordIds: bigint[], tagNames: string[]) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Tags.RecordActionHandler.MasterModel> = await tagsOperations.removeTagsFromMultipleRecords(moduleAPIName, paramInstance);
    ...
    public static async getRecordCountForTag(moduleAPIName: string, tagId: bigint) {
        ...
        let response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.Tags.CountHandler.MasterModel> = await tagsOperations.getRecordCountForTag(tagId, paramInstance);
        ...
        if (response != null) {
            ...
            //Get object from response
            let responseObject: ZOHOCRMSDK.Tags.CountHandler.MasterModel = response.getObject();
