    ...
    */
    ...
    private static async fillDataType() {
        ...
        for (let fieldAPIName of fieldAPINameImageUpload) {
            ...
            Utility.apiTypeVsStructureName.set(fieldAPIName, Constants.IMAGE_UPLOAD_NAMESPACE);
        }
        ...
        for (let fieldAPIName of fieldAPINameLineTax) {
            ...
            Utility.apiTypeVsStructureName.set(fieldAPIName, Constants.LINE_TAX_NAMESPACE);
        }
    }
}
